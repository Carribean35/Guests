...
<div class="review-block">
	<div class="review-block-content white">
		<div class="h2"><span>Довольный гость</span></div>
		...
		<div class="review-text">
			<p>
				...
				Если вы похвалите нашего сотрудника, то мы обязательно сообщим об этом ему, его руководству и в службу персонала.
			</p>
			<p>
				Если вам понравились наши услуги, предложения, реклама - честно - нам будет очень приятно.
			</p> 
			<p>
		...
		<form class="review-form-block">
			...
			<div class="radiobuttons-group">
				<div>
					...
					<label for="f3" class="radio-custom">Доставкаs</label>
				</div>
				<div>
